 ...
 * Montmartre implementation : © <Your name here> <Your email address here>
 *
 ...
 * gameoptions.inc.php
 *
 * Montmartre game options description
 *
 ...
 *        with the same ID (see "initGameStateLabels" in montmartre.game.php)
 *
